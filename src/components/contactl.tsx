  ...
  return (
    <div>
      <div className="flex  flex-col items-center justify-between" style={{ fontFamily: 'Prompt' }}>
        ...
        <div className="flex flex-row" style={{ width: '100%',height: "380px" }}>
              <div className="flex flex-row"style={{ width: '330px',height: "114px", marginLeft:"135px",marginTop:"70px"}}>
                ...
                <div style={{paddingLeft:"25px"}}>
                  ...
                  <p className="text-base font-normal text-slate-500">เลขที่ 179/88 ซอยมิตรภาพ 4</p>
                  <p className="text-base font-normal text-slate-500">ตำบล ในเมือง อำเภอเมืองนครราชสีมา </p>
        ...
        <div className="absolute right-0" style={{marginTop:"45px", marginRight:"85px"}}>
          <Form/>
        </div>
      </div>
    </div>
