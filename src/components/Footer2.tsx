  ...
  return (
    ...
    <div className=" flex justify-center" style={{ fontFamily: 'Prompt' }} >
        <div className="flex justify-center bg-orange-400 rounded-2xl w-[1248px]">
            ...
            <div className="flex absolute py-16 px-20 space-x-16">
            <div className="w-80">
...
อสังหาริมทรัพย์</p>
            ...
            <div className="w-80">
                ...
                <div className="flex flex-col space-y-3 text-white ">
                    ...
                    <Link className="hover:text-neutral-800" href={""}>บริการของเรา</Link>
                    <Link className="hover:text-neutral-800" href={""}>ติดต่อเรา</Link>
                    <Link className="hover:text-neutral-800" href={""}>บทความ</Link>
