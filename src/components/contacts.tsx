...
export default function contacts() {
  return (
    <div className="items-center justify-between">
      <div className="flex  flex-col items-center justify-between" style={{ fontFamily: 'Prompt' }}>
        <div className="absolute z-0 bg-orange-100 " style={{ width: '100%',height: "398px" }}>
        </div>
        <div className="z-10" style={{}}>
                <div style={{paddingLeft:"23px",marginBottom:"17px",}}>
                    <p className="text-lg font-medium" style={{paddingTop:"39px",paddingBottom:"17px"}}>ติดต่อพวกเรา</p>
                ...
                <div className="flex flex-row" style={{marginTop:"63px",width: '100%'}}>
                    <div className="flex flex-row"style={{ width: '321px',height: "114px"}}>
                        <div className="">
                        ...
                        <p className="text-base font-normal text-slate-500">เลขที่ 179/88 ซอยมิตรภาพ 4 ตำบล </p>
                        <p className="text-base font-normal text-slate-500">ในเมือง อำเภอเมืองนครราชสีมา </p>
                        <p className="text-base font-normal text-slate-500">จังหวัดนครราชสีมา 30000</p>

                        </div>
                    </div>
                </div>
                <div className="flex flex-row" style={{width: '100%',marginTop:"32px"}}>
                    <div className="flex flex-row"style={{ width: '321px',height: "114px"}}>
                        <div>
                        ...
                        <div style={{paddingLeft:"40px"}}>
                  <p className="text-lg font-semibold" style={{paddingBottom:"14px"}}>ให้เราช่วยคุณ</p>
                  <p className="text-base font-normal text-slate-500">092-793-9094</p>
                  <p className="text-base font-normal text-slate-500">Createder66@gmail.com</p>
                </div>
                    </div>
                </div>
              </div>
