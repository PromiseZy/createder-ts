                    ...
                    <div className="mt-8">
                        <div className="flex text-sm ">
                            <label className="flex">
                                ...
                                <label htmlFor="checkbox1" className="pl-2 h-auto peer-checked:text-indigo-500 text-slate-500">รับทราบนโยบายความปลอดภัย และยืนยันการส่งข้อมูล</label>
                            </label>
                        </div>
                        <div className="flex text-sm pt-2">
                            <label className="flex">
                                ...
                                <span className="absolute peer-checked:bg-indigo-500 border-radius rounded-sm bg-white"
                                style={{width:"10px",height:"10px",marginLeft:"5px",marginTop:"5px",marginBottom:"5px"}}></span>
                                <label htmlFor="checkbox2" className="pl-2 h-auto peer-checked:text-indigo-500 text-slate-500">ยอมรับข่าวสาร ข้อเสนอ และข้อมูลที่เป็นประโยชน์จาก บ้านบ้าน</label>
                            </label>
                        </div>
                    </div>
